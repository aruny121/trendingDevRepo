...
public class MyDeveloperRecyclerViewAdapter extends RecyclerView.Adapter<MyDeveloperRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnDeveloperFragmentInteractionListener mListener;

    public MyDeveloperRecyclerViewAdapter(List<DummyItem> items, OnDeveloperFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_developer, parent, false);
